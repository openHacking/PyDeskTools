...
class FileSystem:
    ...
    @staticmethod
    def load_configuration(name: str = 'config.yaml', config_directory: Optional[str] = None) -> dict:
...
class LogUtil(Logger):
    ...
    def __init__(self, name: str, log_format: str = __FORMATTER, level: Union[int, str] = DEBUG, *args, **kwargs) -> None:
